...
@Component({
  selector: 'layout-temperatureAnal',
  templateUrl: './temperatureAnal.component.html',
  styleUrls: []
})


export class TemperatureAnalComponent implements OnInit {
  ...
  constructor(
    private Analyservices: TemperatureAnalServices,
  ...
  drawData(data): void {
    ...
    data.forEach((item, index) => {
      ...
      yData.push((item.temperature.toString()));
    });
    this.chartOption1 = {
      tooltip: {
        trigger: 'axis'
